...
int ft_exec_builtin(char **cmd, t_data *data, char **cmd_quotes)
{
	...
	{
		err_value = ft_exit(cmd, data, cmd_quotes);
		return (1);
	}
...
{
	if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "env", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 3)
		return (1);
	else if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "export", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 6)
		return (1);
	else if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "echo", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 4)
		return (1);
	else if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "cd", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 2)
		return (1);
	else if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "pwd", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 3)
		return (1);
	else if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "unset", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 5)
		return (1);
	else if (cmd && ft_strlen(cmd[0]) != 0 && ft_strncmp(cmd[0], "exit", ft_strlen(cmd[0])) == 0 && ft_strlen(cmd[0]) == 4)
		return (1);
    else
		return (0);
}
